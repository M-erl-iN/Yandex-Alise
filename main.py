...
cities = {
    'москва': ['1030494/d28b182804ee311f7fc4', '937455/71abaca1a4109ff78b97'],
    'нью-йорк': ['937455/98c7200664dd76398b5e', '1652229/360769521b840f103dc1'],
    'париж': ['937455/d98fc9385a0b22b4c478', '997614/713a35669b5e0b05a538']
}
...
def handle_dialog(res, req):
    ...
    try:
        if req['request']['command'] == 'помощь':
            res['response']['text'] = 'Вы в тестовом навыке для Алисы'
            return
